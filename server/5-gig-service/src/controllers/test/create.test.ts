...
import { BadRequestError } from '@tameem-rafay-pikessoft/jobber-share';
import { Request, Response } from 'express';
import { gigCreate } from '@gig/controllers/create';
import * as helper from '@tameem-rafay-pikessoft/jobber-share';
...
jest.mock('@tameem-rafay-pikessoft/jobber-share');
jest.mock('@tameem-rafay-pikessoft/jobber-share');
